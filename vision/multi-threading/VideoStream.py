        ...
        if self.path.endswith(".mjpg"):
            ...
            while True:
                try:
                    # Take in stream.
                    img = streamFrame
                    # Do calculations for resizing of image.
                    scalePercent = 150
                    ...
                    # Convert image to 3 'phase' RGB
                    imgRGB = cv2.cvtColor(resized, cv2.COLOR_BGR2RGB)
                    # Convert numpy array to readable image.
                    jpg = Image.fromarray(imgRGB)
                    # Output to MJPG server.
                    ...
                    # Refresh rate of about 20 FPS at 0.05.
                    time.sleep(0.05)
                except stopped:
                    break
            return
